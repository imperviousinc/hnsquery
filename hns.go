...
#cgo windows LDFLAGS: ${SRCDIR}/build/lib/libuv.a ${SRCDIR}/build/lib/libhsk.a -lws2_32 -liphlpapi -luserenv -lbcrypt
#cgo ios LDFLAGS: -L${SRCDIR}/build/ios/lib -luv -lhsk
#cgo darwin,!ios LDFLAGS: -L${SRCDIR}/build/darwin/lib -luv -lhsk
*/
import "C"
import (
	"context"
